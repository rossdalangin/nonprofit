...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'causepro' ); ?></a>
	...
	<header id="masthead" class="site-header">
        ...
        <div class="header-cta">
            <a href="<?php echo esc_url( get_theme_mod( 'causepro_donation_link', '#' ) ); ?>" class="button donate-button">
                <?php echo esc_html( get_theme_mod('causepro_hero_button_text', __( 'Donate Now', 'causepro' ) ) ); ?>
            </a>
        </div>
